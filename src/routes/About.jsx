...
return (
    <div style={{ backgroundColor: 'white', borderRadius: '10px', padding: '20px' }}>
        <h1>About</h1>
        <p>Welcome to the About page of AstroDash!</p>
        <p>AstroDash is your go-to platform for exploring fascinating astronomical data. On the Home page, you will find a variety of data visualizations that provide insights into celestial events, star formations, and planetary movements.</p>
        <p>Our goal is to make complex astronomical data accessible and engaging for everyone. Whether you're a seasoned astronomer or just starting your journey into the cosmos, AstroDash has something for you.</p>
